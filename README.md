...
```
cd existing_repo
git remote add origin https://gitlab.com/lappsufrn/auto-tuning.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lappsufrn/auto-tuning/-/settings/integrations)
